...
from  indicators_n_pop_data_26_27 import indicators_S1Y5D, indicators_D7T5G, indicators_T6Y0W, \
indicators_Z9B2Z, indicators_S0E4D, indicators_qox, indicators_qhl, indicators_qua, indicators_quy, \
indicators_qyg, indicators_qt6, indicators_qwu, indicators_qj2, indicators_qjk, indicators_qvv, \
indicators_qr1, indicators_qop, indicators_qrl, indicators_qgh, indicators_qoq, indicators_qks, \
indicators_qe1, indicators_qk1, indicators_qjm, indicators_qhm, indicators_qmf, indicators_qpm, \
indicators_qt1, indicators_qoc, indicators_qsl, indicators_qkk, indicators_qwe, indicators_qf7, \
indicators_qnc, indicators_qwo 
from indicators_n_pop_data_26_27 import m_pop_S1Y5D, m_pop_D7T5G, m_pop_T6Y0W, \
m_pop_Z9B2Z, m_pop_S0E4D, m_pop_qox, m_pop_qhl, m_pop_qua, m_pop_quy, \
m_pop_qyg, m_pop_qt6, m_pop_qwu, m_pop_qj2, m_pop_qjk, m_pop_qvv, \
m_pop_qr1, m_pop_qop, m_pop_qrl, m_pop_qgh, m_pop_qoq, m_pop_qks, \
m_pop_qe1, m_pop_qk1, m_pop_qjm, m_pop_qhm, m_pop_qmf, m_pop_qpm, \
m_pop_qt1, m_pop_qoc, m_pop_qsl, m_pop_qkk, m_pop_qwe, m_pop_qf7, \
m_pop_qnc, m_pop_qwo

from indicators_n_pop_data_26_27 import f_pop_S1Y5D, f_pop_D7T5G, f_pop_T6Y0W, \
f_pop_Z9B2Z, f_pop_S0E4D, f_pop_qox, f_pop_qhl, f_pop_qua, f_pop_quy, \
f_pop_qyg, f_pop_qt6, f_pop_qwu, f_pop_qj2, f_pop_qjk, f_pop_qvv, \
f_pop_qr1, f_pop_qop, f_pop_qrl, f_pop_qgh, f_pop_qoq, f_pop_qks, \
f_pop_qe1, f_pop_qk1, f_pop_qjm, f_pop_qhm, f_pop_qmf, f_pop_qpm, \
f_pop_qt1, f_pop_qoc, f_pop_qsl, f_pop_qkk, f_pop_qwe, f_pop_qf7, \
f_pop_qnc, f_pop_qwo
...
icb_indicators_dict = {
'Central East ICB': indicators_S1Y5D, 'Essex ICB': indicators_D7T5G,  
'Norfolk and Suffolk ICB': indicators_T6Y0W, 'West and North London ICB': indicators_Z9B2Z, 
'Surrey and Sussex ICB': indicators_S0E4D, 'Bath and North East Somerset, Swindon and Wiltshire ICB': indicators_qox,
'Birmingham and Solihull ICB': indicators_qhl,
...
'Dorset ICB': indicators_qvv, 'Gloucestershire ICB': indicators_qr1, 'Greater Manchester ICB': indicators_qop,
'Hampshire and Isle of Wight ICB': indicators_qrl, 'Herefordshire and Worcestershire ICB': indicators_qgh,
'Humber and North Yorkshire ICB': indicators_qoq,
...
'Lincolnshire ICB': indicators_qjm, 'North East and North Cumbria ICB': indicators_qhm, 'North East London ICB': indicators_qmf,
'Northamptonshire ICB': indicators_qpm, 'Nottingham and Nottinghamshire ICB': indicators_qt1,
...
pop_m_dict = {
'Central East ICB': m_pop_S1Y5D, 'Essex ICB': m_pop_D7T5G,  
'Norfolk and Suffolk ICB': m_pop_T6Y0W, 'West and North London ICB': m_pop_Z9B2Z, 
'Surrey and Sussex ICB': m_pop_S0E4D, 
'Bath and North East Somerset, Swindon and Wiltshire ICB': m_pop_qox,
'Birmingham and Solihull ICB': m_pop_qhl,
...
'Dorset ICB': m_pop_qvv, 'Gloucestershire ICB': m_pop_qr1, 'Greater Manchester ICB': m_pop_qop,
'Hampshire and Isle of Wight ICB': m_pop_qrl, 'Herefordshire and Worcestershire ICB': m_pop_qgh,
'Humber and North Yorkshire ICB': m_pop_qoq,
...
'Lincolnshire ICB': m_pop_qjm, 'North East and North Cumbria ICB': m_pop_qhm, 'North East London ICB': m_pop_qmf,
'Northamptonshire ICB': m_pop_qpm, 'Nottingham and Nottinghamshire ICB': m_pop_qt1,
...
pop_f_dict = {
'Central East ICB': f_pop_S1Y5D, 'Essex ICB': f_pop_D7T5G,  
'Norfolk and Suffolk ICB': f_pop_T6Y0W, 'West and North London ICB': f_pop_Z9B2Z, 
'Surrey and Sussex ICB': f_pop_S0E4D, 
'Bath and North East Somerset, Swindon and Wiltshire ICB': f_pop_qox,
'Birmingham and Solihull ICB': f_pop_qhl,
...
'Dorset ICB': f_pop_qvv, 'Gloucestershire ICB': f_pop_qr1, 'Greater Manchester ICB': f_pop_qop,
'Hampshire and Isle of Wight ICB': f_pop_qrl, 'Herefordshire and Worcestershire ICB': f_pop_qgh,
'Humber and North Yorkshire ICB': f_pop_qoq,
...
'Lincolnshire ICB': f_pop_qjm, 'North East and North Cumbria ICB': f_pop_qhm, 'North East London ICB': f_pop_qmf,
'Northamptonshire ICB': f_pop_qpm, 'Nottingham and Nottinghamshire ICB': f_pop_qt1,
...
# Messages summarising which indicators contribute to what (compact version)
def _format_list_for_english(items: list[str]) -> str:
    """Join a list into 'A, B and C' with correct punctuation."""
    if not items:
        return ""
    if len(items) == 1:
        return items[0]
...
def build_weighting_message(
    ind1_name, ind1_weight,
    ind2_name, ind2_weight,
    ind3_name, ind3_weight,
    up1_name, up1_weight,
    up2_name, up2_weight,
    up3_name, up3_weight,
    prop_pop,
    ...
    """
    Build a narrative listing all indicator names first, then the weights,
    adding ', respectively' when there is more than one indicator.
    Keeps previous edge cases and the population remainder clause.
    """
    # Guard: over-allocation
    if prop_pop < 0:
        return ("IMPORTANT! The weighting selected cannot be greater than 100%. "
                "Please amend the weighting.")

    # Collect chosen indicators from listed + uploaded
    selected = []
    for name, w in [
        (ind1_name, ind1_weight),
        (ind2_name, ind2_weight),
        ...
        try:
            ...
            w_float = 0.0
        if w_float > 0 and name and str(name).strip() and str(name).strip() != "Choose an option":
            selected.append((str(name).strip(), int(round(w_float))))

    prop_int = int(round(float(prop_pop))) if prop_pop is not None else 0

    # Edge cases
    if not selected and prop_int == 100:
        return "You selected to allocate the funding solely based on registered population size."
    if not selected and prop_int == 0:
        return "No indicators were given a positive weight."

    # Build names list and weights list
    names = [name for name, _ in selected]
    weights = [f"{w}%" for _, w in selected]

    names_txt = _format_list_for_english(names)
    weights_txt = _format_list_for_english(weights)

    if len(selected) == 1:
        main_sentence = (
            f"You selected the proportion of the funding allocated based on {names_txt} to be {weights_txt}.")
    else:
        main_sentence = (
            f"You selected the proportion of the funding allocated based on {names_txt} to be {weights_txt}, respectively.")

    if prop_int > 0:
        remainder_sentence = (
            f" The remaining {prop_int}% of unassigned weighting will be based on registered population size.")
    else:
        remainder_sentence = ""

    return main_sentence + remainder_sentence
...
################################################################################
        ...
        if prop_pop < 0:
            st.error('IMPORTANT! The weighting selected **cannot be greater than 100%**. Please amend the weighting', icon="⚠️")
        else:
            st.success('Done!')
            msg = build_weighting_message(
                ind_1_choice, ind_1_weight,
                ind_2_choice, ind_2_weight,
                ind_3_choice, ind_3_weight,
                name_indicator_1, uploaded_ind_1_weight,
                name_indicator_2, uploaded_ind_2_weight,
                name_indicator_3, uploaded_ind_3_weight,
                prop_pop,
            )
            if prop_pop < 0:
                st.error(msg, icon="⚠️")
